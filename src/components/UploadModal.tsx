...
import { type PortfolioItemData } from '../../../cdk-from-scratch-fe/src/components/PortfolioItem';
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <select 
              ...
              onChange={(e) => setFormData(prev => ({ ...prev, category: e.target.value as 'travel' | 'handmade' }))}
              required
            >
          ...
          {/* Location (optional) */}
          <div className="space-y-2">
            <label htmlFor="location" className="block">Location (Optional)</label>
            <input
              id="location"
              className="input"
          ...
          <button 
            ...
            disabled={isSubmitting || !formData.title || !formData.description || !formData.category || !formData.image}
          >
