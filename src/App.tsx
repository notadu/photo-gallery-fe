...
const sampleItems: PortfolioItemData[] = [
  ...
  },
  {
    ...
    description:
      "This ceramic bowl was crafted using traditional pottery techniques. The organic shape and earthy glaze reflect my connection to natural materials and sustainable craftsmanship.",
    image:
  ...
  },
  {
    ...
    description:
      "A intricate macrame piece created using natural cotton cord. The geometric patterns and flowing tassels add a bohemian touch to any space.",
    image:
  ...
  },
  {
    ...
    description:
      "Hand-carved cutting boards made from sustainably sourced walnut wood. Each board features a unique grain pattern and is finished with food-safe oil.",
    image:
...
export default function App() {
  const [portfolioItems, setPortfolioItems] =
    useState<PortfolioItemData[]>(sampleItems);
